...
const ProjectCard = ({ title, liveDocs, githubRepo, liveSite, description, tags, image }) => {
    return (
        <div className="h-full mx-2 rounded-md border-gray-300 bg-slate-800/40 px-4 py-4 text-white bg-blend-overlay shadow-lg drop-shadow-lg duration-500 animate-in fade-in lg:px-12">
