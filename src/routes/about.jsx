...
const About = () => {
    return (
        <div className="duration-[350] flex h-full w-full flex-col justify-center p-2 font-mono text-white ease-in animate-in fade-in  lg:w-3/4 lg:p-10">
            ...
            <div className="flex flex-col justify-center gap-x-7 duration-700 ease-in animate-in fade-in lg:flex-row lg:gap-x-20  lg:px-10">
                <div className="flex w-fit flex-col gap-y-2">
                    ...
                    <SkillSet label="Javascript && Typescript" svg={JsSvg} score={4}>
                ...
                <div className="flex w-fit flex-col gap-y-2">
                    ...
                    <SkillSet label="Linux" svg={LinuxSvg} score={5}></SkillSet>
