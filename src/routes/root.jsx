...
export default function Root() {
    ...
    return (
        <div className="animate-noise flex w-full flex-col items-center  bg-neutral-900  bg-opacity-90  bg-noise bg-repeat">
            <Nav
            ...
            {Outlet ? (
                ...
                <>
                    <div className="z-30 w-full gap-5 flex min-h-screen overflow-hidden isolate relative flex-col items-center justify-center text-white lg:h-screen">
                        ...
                        <p className="text-center font-mono text-lg">
                            <span className="font-bold text-green-500">Full Stack</span> Developer{' '}
                            <span className="font-bold">&&</span> Computer Science
                            <span className="font-bold text-green-500"> Engineer</span>
                        </p>
                        ...
                        <div
                            className="absolute left-[calc(50%-4rem)] top-10  -z-10 transform-gpu blur-3xl sm:left-[calc(50%-20rem)] lg:left-48 lg:top-[calc(50%-20rem)] xl:left-[calc(50%-24rem)]"
                            aria-hidden="true"
                        >
                            <div
